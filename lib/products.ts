...
export const featuredProducts: Product[] = [
  ...
  {
    id: "PINNACLE-ROKOLO-NRCS",
    category: "Safety boot",
    name: "Pinnacle Rokolo Safety Boot",
    slug: "safety-boots/pinnacle-rokolo",
    spec: "Full-grain leather · steel toe and midsole · NRCS approved",
    price: "R295.00",
    moq: "MOQ 10",
    colours: ["#1a1a1a"],
...
export const allProducts: Product[] = [
  ...
  },
  {
    ...
    name: "Pinnacle Rokolo Safety Boot",
    slug: "safety-boots/pinnacle-rokolo",
    spec: "Full-grain leather upper · steel toe and steel midsole · PU anti-slip oil-resistant sole · D-ring lacing · lime stitching · NRCS approved",
    price: "R295.00",
    moq: "MOQ 10",
    colours: ["#1a1a1a"],
    image: "/rokolo-boot.png",
    ...
    additionalInfo: [
      ...
      { label: "Toe cap", value: "Steel" },
      { label: "Midsole", value: "Steel (puncture resistant)" },
      { label: "Sole", value: "PU, anti-slip and oil-resistant" },
      { label: "Heat resistance", value: "Up to 90°C" },
      { label: "Lining", value: "Moisture-wicking" },
      { label: "Insole", value: "Cushioned" },
      { label: "Fastening", value: "Lace-up with D-ring eyelets" },
      { label: "Sizes", value: "3 – 12" },
      { label: "Approved by", value: "NRCS" },
    ],
  },
